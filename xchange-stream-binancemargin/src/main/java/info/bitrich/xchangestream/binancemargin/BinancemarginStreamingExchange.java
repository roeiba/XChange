...
import info.bitrich.xchangestream.binancemargin.BinanceStreamingAccountService;
import info.bitrich.xchangestream.binancemargin.BinanceStreamingMarketDataService;
import info.bitrich.xchangestream.binancemargin.BinanceStreamingService;
import info.bitrich.xchangestream.binancemargin.BinanceStreamingTradeService;
import info.bitrich.xchangestream.binancemargin.BinanceUserDataChannel;
import info.bitrich.xchangestream.binancemargin.BinanceUserDataStreamingService;
import info.bitrich.xchangestream.binancemargin.BinanceUserDataChannel.NoActiveChannelException;
...
public class BinancemarginStreamingExchange extends BinancemarginExchange implements StreamingExchange {

  private static final Logger LOG = LoggerFactory.getLogger(BinancemarginStreamingExchange.class);
