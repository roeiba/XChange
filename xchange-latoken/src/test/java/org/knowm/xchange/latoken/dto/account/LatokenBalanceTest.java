...
public class LatokenBalanceTest {
	...
	public void testSetup() throws Exception {
	    ...
	    InputStream is = LatokenBalanceTest.class.getResourceAsStream("/org/knowm/xchange/latoken/dto/account/latoken-balances-response.json");

	    // Use Jackson to parse it
	    ObjectMapper mapper = new ObjectMapper();
	    List<List<LatokenBalance>> readValues = mapper.readValue(is, new TypeReference<List<List<LatokenBalance>>>(){});
