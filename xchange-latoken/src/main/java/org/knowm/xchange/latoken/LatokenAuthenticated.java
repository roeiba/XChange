...
import org.knowm.xchange.latoken.service.LatokenHmacDigest;
...
public interface LatokenAuthenticated extends Latoken {
	 ...
	 * <br>The signature is created by using the secret {@link #API_KEY} to sign the {@code api-endpoint + query-string} of the request.
	 * <br>See Latoken documentation for further details.
	 ...
	 * Allowed values: {@link BaseParamsDigest#HMAC_SHA_256 HMAC-SHA256} (default), {@link BaseParamsDigest#HMAC_SHA_384 HMAC-SHA384}, 
	 * {@link BaseParamsDigest#HMAC_SHA_512 HMAC-SHA512}
	 */
	 ...
	 * 
	 * @param symbol - Symbol of traded pair (e.g. LAETH)
	 * @param status - Status of order ['active', 'partiallyFilled', 'filled', 'cancelled'] (default: 'active')
	...
	LatokenUserTrades getUserTrades(
	  ...
	  * @throws LatokenException
	  */
	 List<List<LatokenBalance>> getBalances(
			 @QueryParam("timestamp") Long timestamp,
			 @HeaderParam(API_KEY) String apiKey,
			 @HeaderParam(SIGNATURE) ParamsDigest signature)
					 throws IOException, LatokenException;
	 ...
	 @GET
	 @Path("pi/v1/Account/balances/{currency}")
	 /**
