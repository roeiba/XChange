...
public interface Latoken {
	 ...
	 * @throws IOException
 	 * @throws LatokenException
	 */
	List<LatokenPair> getPairs(@PathParam("currency") String currency) throws IOException, LatokenException;
	 ...
	 * @throws IOException
 	 * @throws LatokenException
	 */
	LatokenCurrency getCurrencies(@PathParam("symbol") String symbol) throws IOException, LatokenException;
	 ...
	 * @throws IOException
 	 * @throws LatokenException
	 */
	LatokenOrderbook getOrderbook(@PathParam("symbol") String symbol, @PathParam("limit") int limit) throws IOException, LatokenException;
	 ...
	 * @throws IOException
 	 * @throws LatokenException
	 */
	LatokenTrades getTrades(@PathParam("symbol") String symbol, @PathParam("limit") int limit) throws IOException, LatokenException;
}
