...
public class LatokenTradeServiceRaw extends LatokenBaseService {
	 ...
	 * @throws IOException
	 */
	public LatokenOrder getLatokenOrder(String orderId) 
			throws LatokenException, IOException {
		
		return latoken.getOrder(
				orderId,
				super.apiKey,
				super.signatureCreator);
	}
	...
	/**
	 * Returns list of orders of a given {@link CurrencyPair pair} and {@link LatokenOrderStatus status}.
	 * <br>This includes both open-orders <b>and</b> order-history.
	 * 
	 * @param pair
	 * @param status
	 ...
	 * @throws IOException
	 */
	public List<LatokenOrder> getLatokenOrders(CurrencyPair pair, LatokenOrderStatus status, Integer limit) 
			throws LatokenException, IOException {
	 ...
	 * @throws LatokenException
	 */
	public LatokenOrder cancelLatokenOrder(String orderId) 
			throws IOException, LatokenException {
