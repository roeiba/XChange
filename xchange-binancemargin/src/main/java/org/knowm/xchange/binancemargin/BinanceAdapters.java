...
import org.knowm.xchange.binancemargin.service.BinanceTradeService.BinanceOrderFlags;
...
public class BinanceAdapters {
  ...
  public static org.knowm.xchange.binancemargin.dto.trade.OrderType adaptOrderType(StopOrder order) {
    ...
    switch (order.getIntention()) {
      case STOP_LOSS:
        return order.getLimitPrice() == null
            ? org.knowm.xchange.binancemargin.dto.trade.OrderType.STOP_LOSS
            : org.knowm.xchange.binancemargin.dto.trade.OrderType.STOP_LOSS_LIMIT;
      case TAKE_PROFIT:
        return order.getLimitPrice() == null
            ? org.knowm.xchange.binancemargin.dto.trade.OrderType.TAKE_PROFIT
            : org.knowm.xchange.binancemargin.dto.trade.OrderType.TAKE_PROFIT_LIMIT;
      default:
